...
public class ActorNode extends DrawNodeAdapter {
    ...
    @Deprecated public static ActorNode newInstance( SpatialObject spatial, double[] baseTransform ) {
    ...
    public ActorNode( SpatialObject spatial, double[] optBaseTransform ) {
        mSpatial = spatial != null ? spatial : new SpatialObject();
        mBaseTransform = optBaseTransform != null ? optBaseTransform.clone() : null;
    }
