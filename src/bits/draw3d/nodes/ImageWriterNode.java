...
import bits.draw3d.util.DepthFileEncoder;
import bits.png.*;
 ...
 * <p>
 * May be configured to use a separate thread for writing or with writes
 * performed synchronously by the rendering thread.
 * 
 * @author decamp
 */
@Deprecated public class ImageWriterNode extends DrawNodeAdapter {
                                              ...
                                              throws IOException
    {
        ...
        OutputFileNamer fileMaker = new OutputFileNamer( outDir, nameStart, ".png", minDigits, numStart );
                                              ...
                                              throws IOException
    {
        ...
        OutputFileNamer fileMaker = new OutputFileNamer( outDir, nameStart, ".depth", minDigits, numStart );
    ...
    private final class ColorReader implements FrameReader {
        ...
        private final OutputFileNamer mFileMaker;
        ...
        ColorReader( OutputFileNamer fileMaker,
                     Executor exec,
                     FileWriter writer,
                     int compLevel,
                     int encodeThreads,
    ...
    private final class DepthReader implements FrameReader {
        ...
        DepthReader( OutputFileNamer fileMaker,
                     Executor exec,
                     FileWriter writer,
                     int compLevel,
                     int encodeThreads,
