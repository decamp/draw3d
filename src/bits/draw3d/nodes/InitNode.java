...
public class InitNode extends DrawNodeAdapter {
    ...
    @Deprecated public static InitNode newInstance( float r, float g, float b, float a ) {
        InitNode ret = new InitNode();
        ret.clearColor( r, g, b, a );
        return ret;
    }


    @Deprecated public void setClearColor( float r, float g, float b, float a ) {
        mClearColor[0] = r;
        mClearColor[1] = g;
        mClearColor[2] = b;
        mClearColor[3] = a;
