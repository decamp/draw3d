...
/** 
 * Picks N-dimensional points.  Uses euclidean distance to determine
 * nearest neighbor. 
 * 
...
public class KdPointTree<P> implements Collection<P>, PointPicker<P> {
    ...
    public boolean approximatePick(P point, PointPickResult<P> out) {
        ...
        for(int i = 0; i < 1000; i++){
            ...
            if(choice == null || choice.mDistance > result.mPickDist)
                break;
    ...
    private Node balance(Node parent, Bounds bounds, List<P> list, Bounds range) {
        ...
        //Sort list according to this dimension and dived list into left, center, and right portions.
    ...
    private static final class PriorityQueue<C extends Comparable<? super C>> {
        private List<C> mList;
        private final int mMax;

        public PriorityQueue(int maxSize) {
            mMax = maxSize;
            mList = new ArrayList<C>(maxSize);
        }
        ...
        public void offer(C c) {
            int idx = Collections.binarySearch(mList, c);
