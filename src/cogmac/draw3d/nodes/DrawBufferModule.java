...
public class DrawBufferModule implements RenderModule {
    ...
    public static DrawBufferModule fromTriangles(Collection<Triangle> tris) {
        boolean tex = false;
        boolean norm = false;
        boolean color = false;
    ...
    public static DrawBufferModule fromTriangles(Collection<Triangle> tris, boolean tex, boolean norm, boolean color) {
        int count = tris.size();
    ...
    public Object getNodes(Class<?> nodeClass, RenderTile tile) {
        ...
        return DrawBufferNode.newInstance(mParams, mVertBuffer, mVertUsage, mIndexBuffer, mIndexUsage);
    }
